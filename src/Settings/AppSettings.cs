...
public sealed class AppSettings
{
    ...
    /// 'Prioriteit/High' and 'Prioriteit/Low' priority rules; an explicit empty list stays empty.
    /// </summary>
    public List<LabelRule> LabelRules { get; set; } = LabelRule.DefaultRules();
    ...
    internal static AppSettings LoadFrom(string path)
    {
        ...
        settings.LabelRules ??= LabelRule.DefaultRules();
