...
- Mentions notification: toast when @mentioned in a PR after app startup, scoped to configured organizations. Seen mentions are marked as read on GitHub so they never re-fire. Toggle in Settings → Notifications.
